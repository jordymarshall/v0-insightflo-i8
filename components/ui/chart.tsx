                  ...
                  <div key={item.dataKey} className="flex items-center justify-between gap-2">
                    <div className="flex items-center gap-1">
                      <div
                        ...
                        style={{
                          backgroundColor: configItem?.color ?? item.fill,
                        }}
                      />
                      <span className="text-xs text-muted-foreground">{configItem?.label ?? item.name}</span>
                    </div>
                    <div className="text-xs font-medium">
                      {typeof item.value === "number"
                        ? item.dataKey === "completionRate"
                          ? `${item.value}%`
                          : item.value
                        : item.value}
                    </div>
...
export { ChartTooltip, ChartLegend, ChartLegendContent, ChartStyle, ChartContext }
